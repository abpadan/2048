...
public class Grid {
	...
	public void addNewTile(int[][] grid) {
		...
		ArrayList<GridCoordinates> coordinates = new ArrayList<GridCoordinates>();
		for (int row = 0; row < grid.length; row++) {
